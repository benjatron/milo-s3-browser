...
function milo_downloads_template() {
  ...
  if( get_query_var( 'post_type') == 'milo_browser' ):
    // Sets post password to match the option generated by the plugin
    set_query_var('post_password', get_option('milo_generated_key') );
    if( get_query_var('name') == get_field('milo_welcome_page', 'milo_browser')->post_name ):
      var_dump($wp_query);
      include( 'views/public/archive-browser.php' );
    endif;
  endif;
}
add_filter('template_include', 'milo_downloads_template');
